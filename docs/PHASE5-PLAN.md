...
তারিখ: ২০২৬-০৯-০৫ · স্ট্যাটাস: শুরু (owner-অনুমোদিত: "phase এর কাজ শুরু করো")
...
## Acceptance criteria
- [ ] kit.lab-এ smolagents install+import+মিনি-এজেন্ট রান ✅ (লগ-প্রমাণ)
- [ ] `মিশন: …` মেসেজে step-সহ বহু-ধাপ কাজ সম্পন্ন (লাইভ টেস্ট)
- [ ] ব্যর্থ টুল অটো-রিট্রাই (লুপ-টেস্ট)
- [ ] GET /api/runner/<key> owner-কোডে 200, বিনা কোডে 401
- [ ] health wv = p10-v73
