...
| **টোকেন বসানো** | ✅ **সম্পন্ন — Drive লাইভ** (`/api/storage` → `configured:true, connected:true`) |

> **🟢 আপডেট ২০২৬-০৯-০৩:** টোকেন বসানো শেষ। লাইভ ভেরিফাইড —
> `https://admission-hub-ai.pages.dev/api/storage` দেখাচ্ছে `drive.connected:true`,
> অ্যাকাউন্ট `mahmudrashel1034@gmail.com`, কোটা ১৮.৪% ব্যবহৃত, ৩টা ব্যাকআপ।
> `/api/files` POST টেস্টে ফাইল KV + Drive দুই জায়গায় গেছে।
> নিচের ধাপগুলো নতুন টোকেন বসানোর সময়ের জন্য থেকে গেল (রেফারেন্স)।
